...
import { 
  ...
  TrendingUp, Users, Shield, BarChart2,Edit,
  ChevronDown
} from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-24 md:py-32">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
              The all-in-one platform to organize your work, manage tasks, and collaborate with your team.
            </p>
     ...
     <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Flexible View Modes</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex space-x-2 bg-gray-800/50 rounded-xl p-1 border border-gray-700/50">
              <button 
                ...
                className={`p-2 rounded-lg flex items-center gap-1 ${activeView === 'grid' ? 'bg-purple-600/20 text-purple-400' : 'text-gray-400 hover:text-white'}`}
              >
                <LayoutGrid size={18} />
              ...
              <button 
                ...
                className={`p-2 rounded-lg flex items-center gap-1 ${activeView === 'list' ? 'bg-purple-600/20 text-purple-400' : 'text-gray-400 hover:text-white'}`}
              >
                <List size={18} />
              ...
              <button 
                ...
                className={`p-2 rounded-lg flex items-center gap-1 ${activeView === 'calendar' ? 'bg-purple-600/20 text-purple-400' : 'text-gray-400 hover:text-white'}`}
              >
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center">
                        <div className={`size-10 rounded-full flex items-center justify-center ${task.completed ? 'bg-green-500/20' : 'bg-gradient-to-br from-purple-600 to-blue-500'}`}>
                          <CheckCircle className={`size-5 ${task.completed ? 'text-green-400' : 'text-white'}`} />
                        </div>
            ...
            {activeView === 'list' && (
              <div className="space-y-4">
                {sampleTasks.map((task) => (
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`size-8 rounded-full flex items-center justify-center mr-3 ${task.completed ? 'bg-green-500/20' : 'bg-gradient-to-br from-purple-600 to-blue-500'}`}>
                        <CheckCircle className={`size-4 ${task.completed ? 'text-green-400' : 'text-white'}`} />
                      </div>
                      <div>
              ...
              <div className="min-h-[300px]">
                ...
                <div className="grid grid-cols-7 gap-1">
                  {Array.from({ length: 35 }).map((_, index) => {
                    const day = index + 1;
                    const hasTask = sampleTasks.some(task => 
                    ...
                    return (
                      <div 
                        key={index} 
                        className={`aspect-square p-1 border border-gray-700/30 rounded ${day === 15 ? 'bg-purple-500/10 border-purple-500/30' : ''}`}
                      >
                        <div className="h-full flex flex-col">
                          <span className={`text-xs ${day > 30 ? 'text-gray-600' : 'text-gray-300'}`}>
                            {day <= 30 ? day : ''}
                          </span>
                          {hasTask && (
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto mb-8">
              Join thousands of productive people who are already using our platform
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
  ...
  const features = [
    {
      ...
      description: "Create tasks with natural language processing and smart suggestions",
      details: [
  ...
  const testimonials = [
    {
      ...
      content: "This platform transformed how our team works. We've seen a 40% increase in project completion rates since implementation.",
      avatar: "https://res.cloudinary.com/dwc3gwskl/image/upload/v1745058876/0/muhelzgqzgf2entuwn7d.jpg"
    },
    {
      name: "Michael Chen",
      role: "CTO at StartupX",
      content: "The analytics dashboard alone is worth the price. Being able to visualize our team's productivity patterns has been game-changing.",
      avatar: "https://res.cloudinary.com/dwc3gwskl/image/upload/v1745084918/0/cbdua0r3roe31h9n1wnp.jpg"
    },
    {
      name: "Emma Rodriguez",
      role: "Freelance Designer",
      content: "As a solo professional, the task automation features save me at least 5 hours per week. The mobile app is incredibly intuitive.",
      avatar: "https://res.cloudinary.com/dwc3gwskl/image/upload/v1745084979/0/qrq9jfyfvphox5vx8wpk.png"
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "We use 256-bit encryption for all data in transit and at rest. Our infrastructure is regularly audited and complies with GDPR, CCPA, and SOC 2 standards."
    },
    {
      question: "Can I use this with my team?",
      answer: "Absolutely! We offer team plans from 2 to 200+ users with collaborative features like shared projects, task assignments, and team analytics."
    },
    {
      question: "Is there a mobile app?",
      answer: "Yes, we have fully-featured iOS and Android apps that sync instantly with your desktop experience. All core functionality is available on mobile."
    },
    {
      question: "What integrations are available?",
      answer: "We integrate with Slack, Google Calendar, Microsoft Teams, Zoom, GitHub, Jira, and 50+ other tools through our API and Zapier connection."
    },
    {
      question: "How does the free trial work?",
      answer: "Get full access to all premium features for 14 days. No credit card required. After the trial, you can choose any paid plan or continue with our free forever tier."
    }
  ];
            ...
            <div className="flex justify-center mt-8 gap-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${activeTestimonial === index ? 'bg-purple-500' : 'bg-gray-700'}`}
                />
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricing.map((tier, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                whileHover={{ y: -5 }}
                className={`bg-gray-800/50 border rounded-xl p-6 ${tier.popular ? 'border-purple-500' : 'border-gray-700/50'} relative`}
              >
                {tier.popular && (
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className={`w-full py-3 rounded-lg font-medium ${tier.popular ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white' : 'bg-gray-700/50 text-gray-300 hover:text-white border border-gray-600'}`}
                >
                  {tier.cta}
                </motion.button>
              </motion.div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown 
                    className={`text-gray-400 transition-transform ${activeFAQ === index ? 'rotate-180' : ''}`} 
                    size={20} 
                  />
                </button>
                <AnimatePresence>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-8">
              Join over 50,000 professionals and teams who use LifeTrack to get more done every day.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8"><img src={appLogoImg} alt="logos" /></div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Blog", "Help Center", "Tutorials", "Webinars", "Community"].map((item, i) => (
                  <li key={i}>
                    <a href="#" className="text-gray-400 hover:text-white transition">{item}</a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["About Us", "Careers", "Contact", "Press", "Legal"].map((item, i) => (
                  <li key={i}>
                    <a href="#" className="text-gray-400 hover:text-white transition">{item}</a>
                  </li>
                ))}
