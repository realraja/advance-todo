...
import { useUpdateImportantEventMutation } from '@/redux/api/user';
...
export default function EditEventDialog({
    ...
    const [updateEvent] = useAsyncMutation(useUpdateImportantEventMutation);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setShow(false)
            await updateEvent('Updating Event...',{
                id: event._id,
                name: eventName,
                date: eventDate
            });
