...
import { useAddMutation } from '@/redux/api/goal';
...
export default function AddGoalFormDialog({
    ...
    const [createGoal] = useAsyncMutation(useAddMutation);
    ...
    const handleSubmit = async () => {
        ...
        setShow(false);
        await createGoal('Creating Work...', {
            type,
            title,
            description,
            doBefore: date,
                            ...
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <Dialog.Title className="text-xl font-semibold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                                        Add {type.charAt(0).toUpperCase() + type.slice(1)} Goal
                                    </Dialog.Title>
                                    <motion.button
